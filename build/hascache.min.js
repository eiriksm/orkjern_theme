...
b=f("./controllers/taxonomy");g.exports={appendCss:function(b,k){var m=k.document,l=m.getElementsByTagName("head")[0],r=m.createElement("style");r.type="text/css";r.styleSheet?r.styleSheet.cssText=b:r.appendChild(m.createTextNode(b));return l.appendChild(r)},getLsOrKickOut:function(b){var k=b.localStorage;return k?k:(b.alert("Your browser is bad, and you should feel bad. You are not welcome here. You will be redirected to a place where you can upgrade your browser."),b.location.href="http://browsehappy.com/")},
init:function(f){var C={window:f,m:h};f.test&&h.deps(f);var g=f.document;h.route.mode="pathname";C.controllers={index:new aa(C),node:r,taxonomy:new b(C)};C.booter=new k(C);C.booter.attach();l(C.window);m(C.window);f.disqus_shortname="{{ disqus_shortname }}";if(!f.disqus_shortname||!f.disqus_shortname.length)return C;f.DISQUSWIDGETS=void 0;if(g.querySelectorAll&&0===g.querySelectorAll("a[data-disqus-identifier]").length)for(var x=g.querySelectorAll(".views-field-view-node a"),n=0,T=x.length;n<T;n++){var O=
g.createElement("div");O.className="comment-count";var K=g.createElement("a");K.href=x[n].pathname;K.setAttribute("data-disqus-identifier",x[n].pathname);O.appendChild(K);x[n].parentNode.parentNode.parentNode.insertBefore(O,x[n].parentNode.parentNode.nextSibling)}x=g.createElement("script");x.async=!0;x.type="text/javascript";x.src="//"+f.disqus_shortname+".disqus.com/count.js";(g.getElementsByTagName("HEAD")[0]||g.getElementsByTagName("BODY")[0]).appendChild(x);return C}}},{"./booter":3,"./controllers/index":4,
"./controllers/node":5,"./controllers/taxonomy":6,"./disqus":7,"./gist":8,mithril:12}],3:[function(f,g,n){function h(k){this.app=k;this.window=k.window;var l=k.controllers.index,m=k.controllers.node;k=k.controllers.taxonomy;this.booted=!1;this.routeConf={};this.routeConf["/"]=l;this.routeConf["/node"]=l;this.routeConf["/:alias"]=m;this.routeConf["/node/:nid"]=m;this.routeConf["/taxonomy/term/:tid"]=k;var r=this.app.m;this.m=r;var l=this.window.document,f=this;this.startFunction=function(){var b=this.getAttribute("href");
f.navigate(b);return!1};if(l=l.getElementById("logo"))l.onclick=function(){"/"!==r.route()&&f.navigate("/");return!1}}g.exports=h;h.prototype.attach=function(k){var l=this.window.document;if(l&&l.querySelectorAll){k=l.querySelectorAll(k||"#main-wrapper a");for(var l=0,m=k.length;l<m;l++)k[l].onclick=this.startFunction}};h.prototype.navigate=function(k){var l=this.window;!this.booted&&l&&l.document&&(this.m.route(l.document.getElementById("main-wrapper"),k,this.routeConf),this.booted=!0);this.m.route(k)};
h.prototype.navigateEl=function(k,l){var m=k.getAttribute("href");l.navigate(m);return!1}},{}],4:[function(f,g,n){n=f("../views/index");var h=f("../http"),k={},l=function(k){var l=k.m;return function(){var f=k.window,b=this;this.nodes=l.prop([]);h("node").then(function(l){b.nodes=l;setTimeout(function(){k.booter.attach(".field-type-taxonomy-term-reference a")},2);var r=k.window.document;f.DISQUSWIDGETS=void 0;f.disqus_shortname&&function(){var b=r.createElement("script");b.async=!0;b.type="text/javascript";
b.src="//"+f.disqus_shortname+".disqus.com/count.js";(r.getElementsByTagName("HEAD")[0]||r.getElementsByTagName("BODY")[0]).appendChild(b)}()});this.navigate=function(b){k.booter.navigateEl(b,k.booter)}}};k.view=n;g.exports=function(m){k.app=m;k.controller=new l(m);return k}},{"../http":9,"../views/index":10}],5:[function(f,g,n){var h=f("mithril");n=f("../views/node");var k=f("../http"),l=f("../gist"),m=f("../disqus");f={controller:function(){var r=this;this.title=h.prop("");this.body=h.prop("Loading...");
this.raw=h.prop({});this.image=h.prop("about:blank");r.submitted=h.prop("");var f;this.imageClass=h.prop("noplay");this.toggleImageClass=function(){h.startComputation();r.imageClass("play");f&&r.image(f);h.endComputation()};var b=h.route.param("alias"),g=h.route.param("nid");if(!b){if(!g){h.route("/");return}b="node/"+g}k(b).then(function(b){if(b){var k=new Date(1E3*b.created[0].value);r.title(b.title[0].value);r.body(b.body[0].value);r.submitted("Submitted "+k.toLocaleDateString());for(var h in b._links)1>
h.indexOf("image")||!b._links.hasOwnProperty(h)||!h.indexOf("image")||(f=b._links[h][0].href);r.raw=b;setTimeout(function(){l(window)},200);window.disqus_shortname="{{ disqus_shortname }}";setTimeout(function(){m(window)},200)}},function(b){404===b&&(r.title("404 not found!"),r.body("The page you are looking for is nowhere to be found. Real sorry about that!"),r.imageClass("hide"));403===b&&(r.title("403 Forbidden!"),r.body("You are not allowed to access this page. I am guessing you already knew that!"))})}};
f.view=n;g.exports=f},{"../disqus":7,"../gist":8,"../http":9,"../views/node":11,mithril:12}],6:[function(f,g,n){n=f("../views/index");var h=f("../http"),k={},l=function(k){var l=k.m;return function(){var f=this;this.nodes=l.prop([]);var b=l.route.param("tid");h("taxonomy/term/"+b).then(function(b){b.map(function(b){b.body=""});f.nodes=b;window.disqus_shortname="{{ disqus_shortname }}";setTimeout(function(){k.booter.attach(".field-type-taxonomy-term-reference a")},2);window.disqus_shortname&&window.disqus_shortname.length&&
