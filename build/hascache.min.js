...
b=f("./controllers/taxonomy");g.exports={appendCss:function(b,k){var m=k.document,l=m.getElementsByTagName("head")[0],r=m.createElement("style");r.type="text/css";r.styleSheet?r.styleSheet.cssText=b:r.appendChild(m.createTextNode(b));return l.appendChild(r)},getLsOrKickOut:function(b){var k=b.localStorage;if(!k){if(b.navigator.userAgent.match(/Twitter/))return!1;b.alert("Your browser is bad, and you should feel bad. You are not welcome here. You will be redirected to a place where you can upgrade your browser.");
